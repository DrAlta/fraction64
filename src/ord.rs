...
mod tests {
    ...
    fn neg_one_cmp_one() {
        assert_eq!(
            Fraction::NEG_ONE.cmp(&Fraction::ONE),
            Ordering::Less
        )
    }
    #[test]
    fn one_cmp_neg_one() {
        assert_eq!(
            Fraction::ONE.cmp(&Fraction::NEG_ONE),
            Ordering::Greater
        )
    }
    #[test]
    fn one_cmp_neg_third() {
        assert_eq!(
            Fraction::ONE.cmp(&Fraction::NEG_THIRD),
            Ordering::Greater
        )
    }
    #[test]
    fn neg_third_cmp_one() {
        assert_eq!(
            Fraction::NEG_THIRD.cmp(&Fraction::ONE),
            Ordering::Less
        )
    }
    #[test]
    fn neg_one_cmp_neg_third() {
        assert_eq!(
            Fraction::NEG_ONE.cmp(&Fraction::NEG_THIRD),
            Ordering::Less
        )
    }
    #[test]
